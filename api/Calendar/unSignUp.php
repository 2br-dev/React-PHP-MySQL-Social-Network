...
$stmt = $calendar->unSignUp($userName);

if ($stmt) {
  echo json_encode(array("success" => "Successfully unsigned from event."));
} else {
  echo json_encode(array("error" => "Doesn`t unsigned from event."));
}
