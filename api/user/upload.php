...
if (!file_exists("../../frontend/public/upload/avatars/$id/")) {
   mkdir("../../frontend/public/upload/avatars/$id/", 0777, true);
}
/* Location */
$location = "../../frontend/public/upload/avatars/$id/" . $filename;
...
if ($uploadOk == 0) {
   ...
   $folder = "../../frontend/public/upload/avatars/$id/";
   ...
   $fileNewName = time();
   $folderPath = "../../frontend/public/upload/avatars/$id/";
